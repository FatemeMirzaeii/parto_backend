...
//   if (usrPartner == null || usrPartner == "")  return res
            // .status(400)
            // .json({
            //     status: "error",
            //     data: {},
...
//   let usr = await user.findByPk(req.params.userId);
//   if (usr == null || req.body.type == "" || req.body.type == null)  return res
//             .status(400)
//             .json({
//                 status: "error",
//                 data: {},
//                 message: await translate("INVALIDENTRY", req.params.lang)
//             });
// //   if (usr.version_type != "Teenager" || req.body.type != "Main")  return res
//             .status(400)
//             .json({
//                 status: "error",
//                 data: {},
...
router.delete("/userInfo/:userId/:lang", auth, async (req, res) => {
  let usr = await user.findByPk(req.params.userId);
  if (usr == null) return res
    .status(400)
    .json({
